	...
	return (
		<div className={styles.currencies}>
			<ul className={styles.currencies__item}>
				<li className={styles.currencies__dollar}>USD: Загрузка...
  </li>
...
if(!isLoading){
	...
	return (
		<div className={styles.currencies}>
			<ul className={styles.currencies__item}>
				<li className={styles.currencies__dollar}>USD: {`buy: ${USD.rateBuy} / sell: ${USD.rateSell}`}</li>
				<li className={styles.currencies__euro}>EUR: {`buy: ${EUR.rateBuy} / sell: ${EUR.rateSell}`}</li>
			</ul>
		</div>
	);
}
